...
public class VueLanguage implements EditorLanguage {
    ...
    public int getIndentAdvance(String content) {
        try {
            VueLexer lexer = new VueLexer(CharStreams.fromReader(new StringReader(content)));
            Token token;
            int advance = 0;
