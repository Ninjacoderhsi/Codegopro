...
public class ShellActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		setTitle(Html.fromHtml("<font color=\"#FFA104\">Shell</font>"));
		...
		roadcommend = getIntent().getStringExtra("shell");
		boolean root = false;
		new RunCommandTask(root).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, roadcommend);
