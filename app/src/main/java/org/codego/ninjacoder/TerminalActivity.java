...
public class TerminalActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
			Window w =TerminalActivity.this.getWindow();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		MenuItem menuitem1 = menu.add(Menu.NONE, 0, Menu.NONE, "run");
		menuitem1.setIcon(R.drawable.play);
		menuitem1.setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
		MenuItem menuitem2 = menu.add(Menu.NONE, 1, Menu.NONE, "Undo");
		menuitem2.setIcon(R.drawable.cutting_4);
		menuitem2.setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
		MenuItem menuitem3 = menu.add(Menu.NONE, 2, Menu.NONE, "Redo");
		menuitem3.setIcon(R.drawable.cutting_2);
